---
title: OAuth Setup
description: Configure Google and GitHub OAuth providers for your MaddieHQ application.
---

MaddieHQ includes Google and GitHub OAuth via Better Auth, with support for additional providers.
