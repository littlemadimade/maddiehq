...
description: Set up your MaddieHQ development environment and run the app locally.
---
...
| `APP_NAME` | Display name in emails/UI | `MaddieHQ` |
| `DATABASE_PATH` | SQLite database file path | `./data/maddiehq.db` |
