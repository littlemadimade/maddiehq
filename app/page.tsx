  ...
  return (
    <main className="page">
      <section className="hero panel">
        <div>
          <p className="eyebrow">Maddie Social HQ</p>
          <h1>One dashboard to track what your content is doing across TikTok and Instagram.</h1>
          <p className="lede">
            This first version is your MVP: one place to compare platform insights,
            spot what is working, and get suggestions for what to try next.
          </p>
        </div>
